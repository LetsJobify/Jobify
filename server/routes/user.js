...
router.post('/login', userController.verifyUser, (req,res)=> res.status(200).json('Success'));
...
router.post('/', userController.createUser, (req, res) => res.status(200).json('Success'));
